package com.example.androidweatherapp.worker
...
import com.example.androidweatherapp.data.local.database.JournalDao
import com.example.androidweatherapp.data.local.database.entity.JournalEntity
import com.example.androidweatherapp.data.local.database.entity.SyncOperationType
import com.example.androidweatherapp.data.local.database.entity.SyncQueueEntity
import com.example.androidweatherapp.data.local.database.entity.SyncStatus
import com.example.androidweatherapp.data.local.datastore.TokenManager
import com.example.androidweatherapp.data.remote.api.WeatherJournalApi
import com.example.androidweatherapp.data.remote.dto.CreateEntryRequest
import com.google.gson.Gson
import com.example.androidweatherapp.util.NotificationHelper
