...
object Constants {
    ...
    object Api {
         ...
         */
        val OpenWeatherApiKey = BuildConfig.OPENWEATHER_API_KEY
        /**
     ...
     */
    object Actions {
        const val ACTION_SYNC = "com.example.androidweatherapp.ACTION_SYNC"
        const val ACTION_LOGOUT = "com.example.androidweatherapp.ACTION_LOGOUT"
    }
